...
//     // let full_name = "./py_io/" + file_name;
//     // let mut file = File::open(full_name).expect("Unable to open file!");
//     // let mut json_content = String::new();
//     // file.read_to_string(&mut json_content).expect("Unable to read to file!");
//     // json_content

//     let result = File::open(format!("./py_io/{}", file_name));
...
//     // dummy return to just shut the errors up
//     // remove later
//     return String::from("adsf");
// }
